...
const TarjetaFecha = ({ icono, etiqueta, valor }) => {
  const obtenerIcono = () => {
    switch (icono) {
      case 'calendar':
        return (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2F4858" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'cancel':
        return (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#B4691E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" />
