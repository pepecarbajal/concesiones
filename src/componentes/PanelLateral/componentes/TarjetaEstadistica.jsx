...
const TarjetaEstadistica = ({ icono, etiqueta, valor, color, pequeno }) => {
  const obtenerIcono = () => {
    switch (icono) {
      case 'chart':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2F4858" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'check':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1E7B4F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'area':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#A9812B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'x':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#B4691E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
